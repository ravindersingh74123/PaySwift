...
export default async function Home() {
  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen flex flex-col bg-gray-100 overflow-x-hidden ">
        {/* Hero */}
        <section className="w-full max-w-screen flex-1 flex items-center justify-center px-6 py-20 text-center">
